...
const Checkout = () => {
	...
	const generarOrden = () => {
		...
		const order = { buyer: buyer, items: items, date: currentDate, total: getSumPriceProducts() };
				...
				<div className="row">
					<div className="col">
						<form>
							...
							<button type="button" className="btn text-white bg-black" onClick={generarOrden}>
								Generar Orden
							</button>
						</form>
					</div>
